...
public class Do_Modify_House extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(i==1){
			out.print("<script>alert('修改房屋信息成功');location='http://localhost:8080/HouseSystem/Index.jsp';</script>");
		}
		out.print("<script>alert('修改房屋信息失败');location='http://localhost:8080/HouseSystem/Modify_House.jsp';</script>");
		out.flush();
		out.close();
	}
